        ...
        <div class="brand">
          ...
          <div>
            <div class="brand-title">
              <strong>Nummus Aeternitas Floor Price Dashboard</strong>
              <a class="github-link" href="${GITHUB_REPOSITORY_URL}" target="_blank" rel="noreferrer" aria-label="View Nummus Aeternitas Floor Price Dashboard on GitHub" title="GitHub repository">
